...
class Regions(object):
    ...
    def regions_dof_map(self):
        """
        #SUMMARY: return the regions' corner point numbering
                         ([[SW, SE, NW, NE],
                           [......],
                           [......],
                           ...,
    ...
    def regions_map(self):
        """
        #SUMMARY: return the end points numbering of S, N, W, E boundaries of regions.
    ...
    def regions_angles(self):
        ...
        """
        if self._regions_angles is not None:
            return self._regions_angles

        self._regions_angles = np.zeros(shape=(self.num_regions, 4))
        for i, region in enumerate(self.regions):
            ...
            self._regions_angles[i, :] = [angleSW, angleSE, angleNW, angleNE]
